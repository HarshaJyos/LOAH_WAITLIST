      ...
      <div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 mb-4">
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-1 rounded-full bg-[#10B981]/10 text-[#10B981] text-xs font-semibold border border-[#10B981]/20">
              {post.category}
            </span>
            <span className="px-2.5 py-1 rounded-full bg-white/[0.06] text-[#94A3B8] text-xs font-medium border border-white/10">
              {post.type}
            </span>
          </div>
      ...
      <div className="pt-4 border-t border-white/[0.06] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs text-[#94A3B8]">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[11px] text-[#94A3B8]/70 leading-none">{post.author.role}</p>
          </div>
        </div>
