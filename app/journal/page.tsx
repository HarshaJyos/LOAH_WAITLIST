      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
          ...
          <div className="lg:col-span-3 space-y-6">
            {/* Top Toolbar: Mobile Filter Toggle + Sorting Bar */}
            <div className="p-4 rounded-2xl bg-[#161F2E]/80 border border-white/10 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 shadow-md">
              <div className="flex items-center justify-between sm:justify-start gap-3">
                {/* Mobile Filter Button */}
                <button
                  onClick={() => setIsMobileFilterOpen(true)}
                  className="lg:hidden inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#0B0F17] border border-white/15 text-xs font-semibold text-[#F8FAFC] hover:border-[#10B981]/40 cursor-pointer shadow-sm"
                >
                ...
                <p className="text-xs sm:text-sm text-[#94A3B8]">
                  ...
                  <span className="font-semibold text-[#F8FAFC]">{filteredPosts.length}</span> entries
                </p>
              </div>

              {/* Sort By Dropdown */}
              <div className="flex items-center gap-2 self-end sm:self-auto">
                <span className="text-xs font-semibold text-[#94A3B8] uppercase tracking-wider hidden sm:inline">
                  Sort By:
                </span>
                <div className="relative">
                  <select
                    ...
                    className="h-9 pl-3 pr-8 rounded-xl bg-[#0B0F17] border border-white/10 text-xs font-medium text-[#F8FAFC] focus:outline-none focus:border-[#10B981]/50 cursor-pointer appearance-none"
                  >
